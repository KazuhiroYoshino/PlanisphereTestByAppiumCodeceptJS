...
reserveTestTable.add(['素泊まり','Thursday','9','1','on','on','on','山本寛太','メールでのご連絡','','kanta@example.jp','144文字','シングル','63250']);
...
Feature('Guest予約機能_By_Edge');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Edge', async({I , current}) => {
