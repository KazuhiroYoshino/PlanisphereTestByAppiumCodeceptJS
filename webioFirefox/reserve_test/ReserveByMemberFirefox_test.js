...
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','ディナー付きプラン','Thursday','3','4','on','on','on','メールでのご連絡','','144文字','部屋指定なし','130500']);
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','素泊まり','Sunday','1','1','on','off','off','希望しない','','off','シングル','7875']);
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','貸し切り露天風呂プラン','Friday','3','1','off','off','on','メールでのご連絡','','off','部屋指定なし','32500']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','お得なプラン','Saturday','1','1','off','on','on','希望しない','','144文字','部屋指定なし','9500']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','お得な特典付きプラン','Thursday','9','1','off','off','on','電話でのご連絡','01234567890','144文字','スタンダードツイン','67500']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','カップル限定プラン','Friday','1','2','on','on','on','メールでのご連絡','','off','プレミアムツイン','22000']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','エステ・マッサージプラン','Saturday','1','1','off','on','off','希望しない','','144文字','部屋指定なし','12250']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','お得な特典付きプラン','Saturday','1','1','off','on','off','メールでのご連絡','','off','スタンダードツイン','9750']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','カップル限定プラン','Wednesday','2','2','off','on','on','メールでのご連絡','','off','プレミアムツイン','36000']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','ディナー付きプラン','Monday','1','4','on','on','on','メールでのご連絡','','off','部屋指定なし','46000']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','エステ・マッサージプラン','Sunday','1','6','on','on','on','メールでのご連絡','','off','部屋指定なし','85500']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','お得な特典付きプラン','Friday','1','1','on','on','off','メールでのご連絡','','144文字','スタンダードツイン','9000']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','テーマパーク優待プラン','Monday','5','1','off','on','off','メールでのご連絡','','144文字','部屋指定なし','51000']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','プレミアムプラン','Saturday','9','9','on','off','on','希望しない','','off','プレミアムツイン','990000']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','プレミアムプラン','Thursday','9','9','off','on','off','電話でのご連絡','','144文字','プレミアムツイン','864000']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','出張ビジネスプラン','Wednesday','1','1','off','off','on','希望しない','','144文字','シングル','8500']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','素泊まり','Friday','1','1','off','off','off','希望しない','','off','シングル','5500']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','貸し切り露天風呂プラン','Sunday','1','6','on','on','off','希望しない','','off','部屋指定なし','79500']);
...
Feature('Member予約機能_By_Firefox');

Data(reserveTestTable).Scenario('Member予約_部屋タイプ確認_料金確認_By_Firefox', async({I , current}) => {
