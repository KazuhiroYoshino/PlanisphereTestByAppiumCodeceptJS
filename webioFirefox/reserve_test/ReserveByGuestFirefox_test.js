...
reserveTestTable.add(['エステ・マッサージプラン','Sunday','1','1','off','on','off','上杉景虎','メールでのご連絡','','kagetora@example.jp','off','部屋指定なし','12250']);
reserveTestTable.add(['カップル限定プラン','Tuesday','2','2','on','off','on','直江愛子','電話でのご連絡','01234567890','','off','プレミアムツイン','38000']);
reserveTestTable.add(['テーマパーク優待プラン','Friday','5','9','on','off','off','武田信子','電話でのご連絡','12345678901','','144文字','部屋指定なし','540000']);
reserveTestTable.add(['貸し切り露天風呂プラン','Wednesday','3','6','off','on','off','柿崎家時','希望しない','','','144文字','部屋指定なし','168000']);
...
Feature('Guest予約機能_By_Firefox');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Firefox', async({I , current}) => {
